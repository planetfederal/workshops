...
sys.path.append(os.path.abspath('../../../../scorm/docutils'))
...
extlinks = { 
    ...
    'geot': ('https://osgeo-org.atlassian.net/browse/GEOT-%s','GEOS-')
}
...
htmlhelp_basename = 'GeoWebCachedoc'
...
latex_documents = [
  ('index', 'GeoWebCache.tex', u'GeoWebCache',
   u'Boundless', 'manual'),
]

# The name of an image file (relative to this directory) to place at the top of
# the title page.
#latex_logo = '../../../shared/geoserver.png'
