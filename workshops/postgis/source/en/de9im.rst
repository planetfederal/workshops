...
`ST_Relate(geometry A, geometry B) <http://postgis.net/docs/manual-2.0/ST_Relate.html>`_: Returns a text string representing the DE9IM relationship between the geometries. 
