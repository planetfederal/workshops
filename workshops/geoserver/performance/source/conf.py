...
project = u'GeoServer Performance'
...
extlinks = { 
    'manual': ('http://docs.geoserver.org/stable/en/user/%s',''),
...
html_title = 'GeoServer Performance'
...
htmlhelp_basename = 'GeoServerPerformancedoc'

# Page subheading
html_context = { 'subheading': 'Get the best GeoServer performance <a href="http://boundlessgeo.com/solutions/solutions-software/geoserver/">More info</a>' }
...
latex_documents = [
  ('index', 'geoserverperformance.tex', u'GeoServer Performance',
   u'Boundldess', 'manual'),
]

# The name of an image file (relative to this directory) to place at the top of
# the title page.
latex_logo = 'img/geoserver.png'
